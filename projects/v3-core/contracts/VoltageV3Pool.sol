...
contract VoltageV3Pool is IVoltageV3Pool {
    ...
    function mint(
        ...
        IVoltageV3MintCallback(msg.sender).pancakeV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IVoltageV3SwapCallback(msg.sender).pancakeV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IVoltageV3FlashCallback(msg.sender).pancakeV3FlashCallback(fee0, fee1, data);
